...
The implementation for my scanner is as follows:
...
The only unique data type used in my code is a Pair data dype which I made which is just a key-value pair allowing me to return to value in one return call.